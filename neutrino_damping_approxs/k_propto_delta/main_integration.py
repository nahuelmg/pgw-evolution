...
from params import h1_initial, h2_initial, h3_initial, tau, step_max_num, u_max_num, do_s_interaction, do_neutrino_damping, do_viscosity, spectrum_not_today, do_neutrino_damping_2
