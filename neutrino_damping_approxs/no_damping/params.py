...
do_neutrino_damping = False # esto es conla aproximación K propto delta

do_neutrino_damping_2 = False # esto es con la aproximación K = cte

do_neutrino_damping_3 = False # esto es con la aproximación K = cte, pero con la DTT

do_cosmo_s = False #activa el campos s para los grados de libertad relativistas
...
Tds = 0.125 #1000000000000000 # en GeV temperatura de desacople de s para caso no masivo

do_s_interaction = False # activa la interacción pGW / tensores s,
...
tau = 1e16 # este es el tiempo de relajación hoy, por ejemplo tau\sim1/g**4 Ts (con la temperatura física hoy)

# parámetros de integración

step_max_num = 1e-1 # paso de integración máximo
