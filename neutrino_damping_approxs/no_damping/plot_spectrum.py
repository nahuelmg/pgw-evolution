...
if h1_initial:
    ...
    np.savetxt('spectrum_100_no_damping',spectrum)
...
if h3_initial:
    ...
    if reg_r0:
        ...
        np.savetxt('spectrum_001_',spectrum)
...
np.savetxt('kc_vec_no_damping',kc_vec)

#np.savetxt('Neff_today_',[Neff_today, Neff_today])
