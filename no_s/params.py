...
Tds = 100 #1000000000000000 # en GeV temperatura de desacople de s para caso no masivo
...
tau = 1e8 # este es el tiempo de relajación hoy, por ejemplo tau\sim1/g**4 Ts (con la temperatura física hoy)
