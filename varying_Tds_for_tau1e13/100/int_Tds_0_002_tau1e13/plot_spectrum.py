...
if h1_initial:
    ...
    np.savetxt('spectrum_100_int_Tds_0_002_tau1e13',spectrum)
...
if h3_initial:
    ...
    if reg_r0:
        ...
        np.savetxt('spectrum_001_int_Tds_0_002_tau1e13',spectrum)
...
np.savetxt('kc_vec_int_Tds_0_002_tau1e13',kc_vec)

np.savetxt('Neff_today_int_Tds_0_002_tau1e13',[Neff_today, Neff_today])
