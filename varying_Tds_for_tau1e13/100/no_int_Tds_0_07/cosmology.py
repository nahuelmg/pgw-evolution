...
np.savetxt('f_s_Tds_0_07',f_s)
np.savetxt('temperature_Tds_0_07',T_a(a))
np.savetxt('geff_Tds_0_07',g_a(a))
np.savetxt('kc_horizon_crossing_Tds_0_07',kc_from_horizon_crossing)
