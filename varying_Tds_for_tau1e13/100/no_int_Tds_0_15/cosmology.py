...
np.savetxt('f_s_Tds_0_15',f_s)
np.savetxt('temperature_Tds_0_15',T_a(a))
np.savetxt('geff_Tds_0_15',g_a(a))
np.savetxt('kc_horizon_crossing_Tds_0_15',kc_from_horizon_crossing)
