...
np.savetxt('f_s_Tds_0_175',f_s)
np.savetxt('temperature_Tds_0_175',T_a(a))
np.savetxt('geff_Tds_0_175',g_a(a))
np.savetxt('kc_horizon_crossing_Tds_0_175',kc_from_horizon_crossing)
