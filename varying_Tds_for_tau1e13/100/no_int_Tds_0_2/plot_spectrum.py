...
if h1_initial:
    ...
    np.savetxt('spectrum_100_no_int_Tds_0_2',spectrum)
...
if h3_initial:
    ...
    if reg_r0:
        ...
        np.savetxt('spectrum_001_no_int_Tds_0_2',spectrum)
...
np.savetxt('kc_vec_no_int_Tds_0_2',kc_vec)

np.savetxt('Neff_today_no_int_Tds_0_2',[Neff_today, Neff_today])
