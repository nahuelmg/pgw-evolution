...
np.savetxt('f_s_Tds_0_25',f_s)
np.savetxt('temperature_Tds_0_25',T_a(a))
np.savetxt('geff_Tds_0_25',g_a(a))
np.savetxt('kc_horizon_crossing_Tds_0_25',kc_from_horizon_crossing)
